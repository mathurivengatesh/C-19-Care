...
let url =
 ...
 const loginCred ={
username : "apikey-v2-2mxwaz89u58vkezj2e5jfc41xn3komuaq1j49fhhmu8p",
password : "58de0ca6ebd4250a97d0a7d300191f68"
 };
let _tmp = "name";
let cloudant = Cloudant({ url: url, username: loginCred.username, password: loginCred.password });
